...
Este documento fornece um guia detalhado da arquitetura de código, fluxos de dados, estrutura de arquivos e integrações nativas do **SL Stock**. Ele foi elaborado para auxiliar desenvolvedores e engenheiros a compreenderem o funcionamento interno da plataforma e como dar manutenção ou estendê-la.
...
*   **iOS (`ios/App/App/Info.plist`)**:
    ...
    <string>O Coletor IA necessita de acesso à câmera para realizar a leitura de códigos de barra dos produtos.</string>
    ```
